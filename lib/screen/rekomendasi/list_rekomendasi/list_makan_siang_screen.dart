...
class ListMakanSiang extends StatefulWidget {
  final String userId, idToken;
  final int maxCarb, maxFat, maxCalories;
  const ListMakanSiang({
  ...
  @override
  State<ListMakanSiang> createState() => _ListMakanSiangState();
}

class _ListMakanSiangState extends State<ListMakanSiang> {
